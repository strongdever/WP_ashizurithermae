...
<div class="card card-static">
    <div class="card-body">
        ...
        <p class="small">
            If the default Purchase event doesn't fire when an order is placed by the client, a Purchase event will be sent to Meta and Google using API when the order status is changd to "Completed". Meta Conversion API token and GA4 Measurement Protocol secret are reuquiered.
        </p>
        <div  class="row">
            <div class="col">
                <?php renderDummySwitcher( false ); ?>
